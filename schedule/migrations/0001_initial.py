...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('archive_image_server', models.CharField(blank=True, max_length=100, null=True)),
                ('archive_image_secret', models.CharField(blank=True, max_length=100, null=True)),
                ('archive_image_id', models.CharField(max_length=100, null=True)),
                ('archive_image_name', models.CharField(max_length=100, null=True)),
                ('archive_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='image_files', to='schedule.archivedshowimagedata')),
            ],
        ),
    ]
